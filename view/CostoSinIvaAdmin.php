...
else
{
    ...
    if ($_SESSION['costosinivaadmin']==1) 
    {
        ?>
       <br>
        ...
        <div class="container-fluid">
            ...
            <div class="col-12">
                    ...
                    <div class="card-header">
                        <h1 class="m-0 text-dark">Costo (sin IVA) por Factor de Potencia CFE</h1>
                        <div class="card-input-group d-flex justify-content-end align-items-baseline">
                            <input type="submit" value="Agregar" class="btn btn-success" onclick="location='agregar_costosinivaadmin.php'">
                        </div>
                ...
                <div class="card-body">
                                 ...
                                 <table class="table mitabla table-striped table-bordered table-responsive DT dt-responsive" style="width:100%">
                                        ...
                                        $sql = "SELECT * From fp_costo_sin_iva";
